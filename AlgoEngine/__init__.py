    ...
    def feature_extraction(self):
        ...
        for ptv_name,ptv_tuple in PTV.items():
            for oar_name,oar_tuple in OAR.items():
                #print('oar_tuple',oar_tuple)
                #print('count_oar_tuple_numbers',np.count_nonzero(oar_tuple))
                try:
                    ...
                    #print('oar_roi_block',oar_roi_block)
                    count_non=np.count_nonzero(oar_roi_block)
                    #print('non_zero number is',count_non)
